...
class JLinkWorker(QObject):
    ...
    # Watch UI remains capped at 25 Hz. Scope acquisition chunks may be
    # delivered at up to 60 Hz so the Scope page can offer a true 1..60 FPS
    # render setting without losing raw samples.
    GUI_SNAPSHOT_HZ = 25.0
    SCOPE_EMIT_MAX_HZ = 60.0
    SCOPE_DEFAULT_GUI_HZ = 30.0
    SCOPE_POLL_MS = 5
    ...
    def __init__(self) -> None:
        ...
        self._scope_started_at = 0.0
        self._scope_period_us = 1000
        self._scope_sample_index = 0
    ...
    def start_scope_sampling(self, source: str, specs: list[ScopeChannelSpec], sample_hz: int) -> None:
        try:
            ...
            self._scope_started_at = time.perf_counter()
            self._scope_sample_index = 0
