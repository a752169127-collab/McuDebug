...
## UI / Engineering Controls

- V0.6.11 — Engineering Presets
- V0.6.10 — Compact Connection Panel / Automation Table cleanup

## Scope / Performance

- V0.4.23 — High Performance Clean baseline

> 读取原则：默认先看 Current。只有当前 State/Handoff 无法解释某个设计时，才打开对应历史 Release Report。
