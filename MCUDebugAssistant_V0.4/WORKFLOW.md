...
- `state/PROJECT_STATE.yaml`：当前版本、焦点、Open Issues。
- `state/ISSUE_LEDGER.md`：症状、证据、根因、修复、状态。
- `state/VERSION_HISTORY.md`：这一版为什么存在。
- `state/TEST_STATUS.md`：自动测试与硬件测试分开。
- `state/ADR.md`：仅架构决策变化时追加。
- `state/LATEST_HANDOFF.md`：让新 AI 可以直接继续。
